...
export class McGaugeChart extends ViewPU {
    ...
    setInitiallyProvidedValue(params: McGaugeChart_Params) {
    ...
    updateStateVars(params: McGaugeChart_Params) {
    ...
    initialRender() {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "oh_modules/.ohpm/@mcui+mccharts@2.8.9/oh_modules/@mcui/mccharts/src/main/ets/components/mainpage/McGaugeChart.ets", line: 48, col: 5 });
