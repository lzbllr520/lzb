...
export class McRadarChart extends ViewPU {
    ...
    setInitiallyProvidedValue(params: McRadarChart_Params) {
    ...
    updateStateVars(params: McRadarChart_Params) {
    ...
    initialRender() {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "oh_modules/.ohpm/@mcui+mccharts@2.8.9/oh_modules/@mcui/mccharts/src/main/ets/components/mainpage/McRadarChart.ets", line: 87, col: 5 });
