...
export class McBarChart extends ViewPU {
    ...
    initOption(options: InterfaceObj) {
        ...
        if (!options.tooltip || !options.tooltip.axisPointer || !options.tooltip.axisPointer.type) {
            if (!options.tooltip) {
                options.tooltip = {
                    axisPointer: {}
                };
            }
            if (!options.tooltip.axisPointer) {
    ...
    initialRender() {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "oh_modules/.ohpm/@mcui+mccharts@2.8.9/oh_modules/@mcui/mccharts/src/main/ets/components/mainpage/McBarChart.ets", line: 101, col: 5 });
