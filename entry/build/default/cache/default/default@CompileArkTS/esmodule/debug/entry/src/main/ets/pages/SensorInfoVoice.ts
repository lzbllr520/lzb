...
interface SensorInfoVoice_Params {
    sensorData?: CardData[];
    bgOpacity?: number;
    routeParams?;
    timer?: number;
...
import { getNodeOther, getNodeVoice } from "@normalized:N&&&entry/src/main/ets/service/Request&";
interface CardData {
    title: string;
    value: string;
    unit: string;
...
class SensorInfoVoice extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
    ...
    setInitiallyProvidedValue(params: SensorInfoVoice_Params) {
    ...
    updateStateVars(params: SensorInfoVoice_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                if (isInitialRender) {
                                    let componentCall = new ValueCard(this, {
                                        ...
                                        value: item.value,
                                        unit: item.unit
                                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/SensorInfoVoice.ets", line: 175, col: 17 });
    ...
    static getEntryName(): string {
        return "SensorInfoVoice";
    }
}
registerNamedRoute(() => new SensorInfoVoice(undefined, {}), "", { bundleName: "com.my.myapplication", moduleName: "entry", pagePath: "pages/SensorInfoVoice", pageFullPath: "entry/src/main/ets/pages/SensorInfoVoice", integratedHsp: "false", moduleType: "followWithHap" });
