...
import { codeStyle } from '@normalized:N&&&@luvi/lv-markdown-in/src/main/ets/lv-markdown-in/lib/utils/codeColorOn/index&2.0.15';
import handleCodeLib from '@normalized:N&&&@luvi/lv-markdown-in/src/main/ets/lv-markdown-in/lib/utils/handle/handleCodeLib&2.0.15';
import pasteboard from '@ohos:pasteboard';
import promptAction from '@ohos:promptAction';
import { lvCode } from '@normalized:N&&&@luvi/lv-markdown-in/src/main/ets/lv-markdown-in/lib/domain/LvCode&2.0.15';
const o2 = async (text) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.nCode.getTheme() == "dark") {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": -1, "type": 30000, params: ["imgs/copy_w1.png"], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.width(18);
                        Image.height(18);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": -1, "type": 30000, params: ["imgs/copy_g1.png"], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.width(18);
                        Image.height(18);
                        Image.interpolation(ImageInterpolation.Medium);
                    }, Image);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.calcRow() >= 10 && this.rowLimit != -2) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": -1, "type": 30000, params: ["imgs/down_b.png"], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.width(20);
                        Image.height(20);
                    }, Image);
                    Row.pop();
