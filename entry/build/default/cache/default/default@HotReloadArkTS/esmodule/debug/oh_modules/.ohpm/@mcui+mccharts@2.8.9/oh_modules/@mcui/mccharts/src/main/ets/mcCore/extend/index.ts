import { extendNewGraph } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/cRender/index&2.8.9";
import { text } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/cRender/config/graphs&2.8.9";
import { getCircleRadianPoint, checkPointIsInRect } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/cRender/plugin/util&2.8.9";
import { getColorFromRgbValue } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/util/color&2.8.9";
import { getLinearGradientColor } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/util/index&2.8.9";
const pie = {
    shape: {
        rx: 0,
        ry: 0,
