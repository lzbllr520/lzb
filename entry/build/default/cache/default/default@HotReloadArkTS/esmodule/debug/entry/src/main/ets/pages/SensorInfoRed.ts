...
interface SensorInfoRed_Params {
    sensorData?: CardData[];
    bgOpacity?: number;
    routeParams?;
    timer?: number;
...
import { getNodeOther, getNodeRed1, getNodeRed2 } from "@normalized:N&&&entry/src/main/ets/service/Request&";
interface CardData {
    title: string;
    value: string;
    unit: string;
...
class SensorInfoRed extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
    ...
    setInitiallyProvidedValue(params: SensorInfoRed_Params) {
    ...
    updateStateVars(params: SensorInfoRed_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                if (isInitialRender) {
                                    let componentCall = new ValueCard(this, {
                                        ...
                                        value: item.value,
                                        unit: item.unit
                                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/SensorInfoRed.ets", line: 189, col: 17 });
    ...
    static getEntryName(): string {
        return "SensorInfoRed";
    }
}
registerNamedRoute(() => new SensorInfoRed(undefined, {}), "", { bundleName: "com.my.myapplication", moduleName: "entry", pagePath: "pages/SensorInfoRed", pageFullPath: "entry/src/main/ets/pages/SensorInfoRed", integratedHsp: "false", moduleType: "followWithHap" });
