...
import { gaugeConfig } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/config/gauge&2.8.9";
import { getCircleRadianPoint } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/cRender/plugin/util&2.8.9";
import { deepMerge, initNeedSeries, radianToAngle } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/util/index&2.8.9";
import { getFormatterVal } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/util/common&2.8.9";
import { getRgbaValue } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/util/color&2.8.9";
