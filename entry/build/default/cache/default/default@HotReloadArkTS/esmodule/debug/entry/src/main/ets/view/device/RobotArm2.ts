...
export class RobotArm2 extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        //序列号
        , this, "con_height2");
        this.__sn = new ObservedPropertySimplePU('DT1420071189'
        //固定版本
        , this, "sn");
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new RoboticArmWorkRangeView(this, {
                                    data: this.__data
                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/device/RobotArm2.ets", line: 930, col: 17 });
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/device/RobotArm2.ets", line: 1399, col: 11 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            // 请替换为您的图标资源
