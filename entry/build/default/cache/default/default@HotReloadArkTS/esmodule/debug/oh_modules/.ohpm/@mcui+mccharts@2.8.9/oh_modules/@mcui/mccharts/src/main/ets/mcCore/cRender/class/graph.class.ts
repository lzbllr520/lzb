import Style from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/cRender/class/style.class&2.8.9";
import transition from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/transition/index&2.8.9";
import { deepClone, getRotatePointPos, getScalePointPos, getTranslatePointPos, checkPointIsInRect } from "@normalized:N&&&@mcui/mccharts/src/main/ets/mcCore/cRender/plugin/util&2.8.9";
/**
