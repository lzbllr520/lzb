...
import { lvImage } from '@normalized:N&&&@luvi/lv-markdown-in/src/main/ets/lv-markdown-in/lib/domain/LvImage&2.0.15';
...
import handleImgText from '@normalized:N&&&@luvi/lv-markdown-in/src/main/ets/lv-markdown-in/lib/utils/handle/handleImgText&2.0.15';
                    ...
                    if (item.trim().slice(0, 2) == '![' && item.trim().slice(-1) == ')' && item.trim().indexOf('](') !== -1) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Image.alt({ "id": -1, "type": 30000, params: ["imgs/imgErr.png"], "bundleName": "com.my.myapplication", "moduleName": "entry" });
