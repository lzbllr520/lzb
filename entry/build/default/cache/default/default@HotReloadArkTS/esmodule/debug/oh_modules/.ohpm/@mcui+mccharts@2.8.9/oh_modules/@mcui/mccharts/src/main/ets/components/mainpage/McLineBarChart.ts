...
interface McLineBarChart_Params {
    options?: Options;
...
export class McLineBarChart extends ViewPU {
    ...
    setInitiallyProvidedValue(params: McLineBarChart_Params) {
    ...
    updateStateVars(params: McLineBarChart_Params) {
    ...
    initialRender() {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "oh_modules/.ohpm/@mcui+mccharts@2.8.9/oh_modules/@mcui/mccharts/src/main/ets/components/mainpage/McLineBarChart.ets", line: 34, col: 5 });
