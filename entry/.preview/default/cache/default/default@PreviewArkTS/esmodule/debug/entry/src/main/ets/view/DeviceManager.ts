...
export class DeviceManager extends ViewPU {
    ...
    deviceContent(index: number, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/DeviceManager.ets(43:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            if (index === 0) {
    ...
    tabBuilder(title: string, targetIndex: number, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/DeviceManager.ets(89:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/view/DeviceManager.ets(90:7)", "entry");
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/view/DeviceManager.ets(118:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/DeviceManager.ets(119:7)", "entry");
            Row.width('100%');
            Row.height('8%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Tabs.debugLine("entry/src/main/ets/view/DeviceManager.ets(120:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TabContent.debugLine("entry/src/main/ets/view/DeviceManager.ets(122:13)", "entry");
                }, TabContent);
                TabContent.pop();
            };
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Swiper.debugLine("entry/src/main/ets/view/DeviceManager.ets(152:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/view/DeviceManager.ets(154:11)", "entry");
                    Column.width('100%');
                    Column.height('100%');
                    Column.justifyContent(FlexAlign.Center);
                }, Column);
