...
export class Conveyor1 extends ViewPU {
    ...
    private buildImagePreview(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/device/Conveyor1.ets(280:5)", "entry");
            // 使用Stack作为根布局，以实现覆盖效果
            Stack.width('100%');
            // 使用Stack作为根布局，以实现覆盖效果
            Stack.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("entry/src/main/ets/view/device/Conveyor1.ets(282:7)", "entry");
            // 半透明背景遮罩，本身就作为可点击关闭的区域
            Column.width('100%');
            // 半透明背景遮罩，本身就作为可点击关闭的区域
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/device/Conveyor1.ets(292:7)", "entry");
            // 居中显示的、放大的图片
            Image.width('50%');
            // 居中显示的、放大的图片
