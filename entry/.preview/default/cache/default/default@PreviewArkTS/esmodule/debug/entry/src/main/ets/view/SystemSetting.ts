...
export class SystemSetting extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/SystemSetting.ets(71:5)", "entry");
            Column.width('100%');
            Column.height('100%');
            Column.padding(24);
    ...
    UserManagementCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/SystemSetting.ets(85:5)", "entry");
            Column.width('95%');
            Column.height('80%');
            Column.padding(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 用户信息区域
            Row.create();
            Row.debugLine("entry/src/main/ets/view/SystemSetting.ets(87:7)", "entry");
            // 用户信息区域
            Row.width('100%');
            // 用户信息区域
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/SystemSetting.ets(89:9)", "entry");
            // 头像
            Image.width(75);
            // 头像
            Image.height(75);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 用户名和角色
            Column.create();
            Column.debugLine("entry/src/main/ets/view/SystemSetting.ets(96:9)", "entry");
            // 用户名和角色
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/SystemSetting.ets(97:11)", "entry");
            Text.fontSize(19);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/SystemSetting.ets(101:11)", "entry");
            Text.fontSize(14);
            Text.fontColor(Color.White);
            Text.margin({ top: 4 });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Blank.create();
            Blank.debugLine("entry/src/main/ets/view/SystemSetting.ets(110:9)", "entry");
        }, Blank);
        // 添加一个灵活的空白填充，将右侧的按钮推到最右边
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/SystemSetting.ets(113:9)", "entry");
            //相机按钮
            Button.width(50);
            //相机按钮
            Button.height(50);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777246, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/view/SystemSetting.ets(114:11)", "entry");
            Image.width(28);
            Image.height(28);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/SystemSetting.ets(131:7)", "entry");
            //退出登录按钮
            Button.width('100%');
            //退出登录按钮
            Button.height(48);
