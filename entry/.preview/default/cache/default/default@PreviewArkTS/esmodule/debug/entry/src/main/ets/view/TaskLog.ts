...
export class TaskLog extends ViewPU {
    ...
    private getLevelStyle(level: 'info' | 'warning' | 'error'): LevelStyle {
        switch (level) {
            case 'info':
                return { icon: { "id": 16777274, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" }, color: Color.White };
            case 'warning':
                return { icon: { "id": 16777268, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" }, color: Color.Yellow };
            case 'error':
                return { icon: { "id": 16777269, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" }, color: Color.Red };
        }
    }
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/TaskLog.ets(62:5)", "entry");
            Column.width('100%');
            Column.height('100%');
            Column.padding(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 10 });
            Row.debugLine("entry/src/main/ets/view/TaskLog.ets(63:7)", "entry");
            Row.width('100%');
            Row.margin({ bottom: 20 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/TaskLog.ets(64:9)", "entry");
            Row.layoutWeight(1);
            Row.height(50);
            Row.borderRadius(15);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/TaskLog.ets(65:11)", "entry");
            Image.width(20);
            Image.height(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/view/TaskLog.ets(71:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/TaskLog.ets(86:9)", "entry");
            Button.height(50);
            Button.width(80);
            Button.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/TaskLog.ets(91:9)", "entry");
            Button.height(50);
            Button.width(80);
            Button.fontSize(16);
            Button.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/view/TaskLog.ets(100:7)", "entry");
            Scroll.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/view/TaskLog.ets(101:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Row.create({ space: 15 });
                    Row.debugLine("entry/src/main/ets/view/TaskLog.ets(106:15)", "entry");
                    // 确保 Row 组件内包含用于显示内容的子组件
                    Row.width('100%');
                    // 确保 Row 组件内包含用于显示内容的子组件
                    Row.padding(15);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Image.debugLine("entry/src/main/ets/view/TaskLog.ets(108:17)", "entry");
                    // 等级图标
                    Image.width(24);
                    // 等级图标
                    Image.height(24);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/view/TaskLog.ets(114:17)", "entry");
                    // 时间戳和消息
                    Column.alignItems(HorizontalAlign.Start);
                    // 时间戳和消息
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/view/TaskLog.ets(115:19)", "entry");
                    Text.fontSize(16);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/view/TaskLog.ets(121:19)", "entry");
                    Text.fontSize(12);
