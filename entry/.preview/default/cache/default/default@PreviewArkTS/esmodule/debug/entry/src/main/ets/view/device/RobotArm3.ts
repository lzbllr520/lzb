...
export class RobotArm3 extends ViewPU {
    ...
    private buildImagePreview(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(187:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(188:7)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(196:7)", "entry");
            Image.width('50%');
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(208:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 20 });
            Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(209:7)", "entry");
            Row.padding(20);
            Row.width('100%');
            Row.height('100%');
            ...
            if (!this.data.isInfoCardVisible) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //基础信息展示
                        Stack.create();
                        Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(212:11)", "entry");
                        //基础信息展示
                        Stack.width('30%');
                        //基础信息展示
                        Stack.height('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(213:13)", "entry");
                        Column.width('100%');
                        Column.height('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //模型展示
                        Column.create();
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(215:15)", "entry");
                        //模型展示
                        Column.width('90%');
                        //模型展示
                        Column.height('30%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(216:17)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(236:15)", "entry");
                        //信息展示
                        Column.width('100%');
                        //信息展示
                        Column.height('70%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //机械臂名称
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(238:17)", "entry");
                        //机械臂名称
                        Row.width('100%');
                        //机械臂名称
                        Row.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('名称：');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(239:19)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('机械臂002');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(243:19)", "entry");
                        Text.fontColor(Color.White);
                    }, Text);
                    Text.pop();
                    //机械臂名称
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //机械臂状态
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(251:17)", "entry");
                        //机械臂状态
                        Row.width('100%');
                        //机械臂状态
                        Row.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('运作状态：');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(252:19)", "entry");
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontSize(20);
                        Text.fontColor(Color.White);
                    }, Text);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(256:19)", "entry");
                        Text.fontColor(Color.White);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Circle.create();
                        Circle.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(258:19)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //末端状态
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(269:17)", "entry");
                        //末端状态
                        Row.width('100%');
                        //末端状态
                        Row.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('末端状态：');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(270:19)", "entry");
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontSize(20);
                        Text.fontColor(Color.White);
                    }, Text);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(274:19)", "entry");
                        Text.fontColor(Color.White);
                    }, Text);
                    Text.pop();
                    //末端状态
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //负载状态
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(282:17)", "entry");
                        //负载状态
                        Row.width('100%');
                        //负载状态
                        Row.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('负载：');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(283:19)", "entry");
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontSize(20);
                        Text.fontColor(Color.White);
                    }, Text);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(287:19)", "entry");
                        Text.fontColor(Color.White);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        if (this.data.loadText === '有物品') {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(290:21)", "entry");
                                    Image.width(20);
                                    Image.height(20);
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(295:21)", "entry");
                                    Image.width(20);
                                    Image.height(20);
                                    Image.margin({ left: 10 });
                                }, Image);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //控制按钮
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(306:17)", "entry");
                        ...
                        if (this.data.statusText === '运行中' || this.data.statusText === '空闲中') {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(308:21)", "entry");
                                    Image.width(22);
                                    Image.height(22);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('停止');
                                    Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(310:21)", "entry");
                                    Text.fontSize(18);
                                    Text.fontWeight(FontWeight.Bold);
                                    Text.fontColor(Color.White);
                                    Text.margin({ left: 8 });
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(312:21)", "entry");
                                    Image.width(24);
                                    Image.height(24);
                                    Image.fillColor(Color.White);
                                }, Image);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('启动');
                                    Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(314:21)", "entry");
                                    Text.fontSize(18);
                                    Text.fontWeight(FontWeight.Bold);
                                    Text.fontColor(Color.White);
                                    Text.margin({ left: 8 });
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //地图信息卡片
                        Stack.create();
                        Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(440:11)", "entry");
                        //地图信息卡片
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(441:13)", "entry");
                        Column.width('100%');
                        Column.height('100%');
                        Column.justifyContent(FlexAlign.Center);
                        Column.alignItems(HorizontalAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(442:15)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(24);
                    }, Text);
                    Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(473:9)", "entry");
            //控制区域
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.data.isRegionAVisible) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Stack.create();
                        Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(476:13)", "entry");
                        Stack.width('100%');
                        Stack.height('100%');
                        Stack.clip(true);
                    }, Stack);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(477:15)", "entry");
                        Column.width('100%');
                        Column.height('100%');
                        Column.justifyContent(FlexAlign.Center);
                        Column.alignItems(HorizontalAlign.Center);
                    ...
                    }, Column);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                ...
                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/device/RobotArm3.ets", line: 478, col: 17 });
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(506:13)", "entry");
                        // 原有的控制面板UI
                        Column.justifyContent(FlexAlign.Center);
                        // 原有的控制面板UI
                        Column.width('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //控制x轴（左右）
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(508:15)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(509:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(510:19)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(511:21)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('左');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(534:19)", "entry");
                        Text.fontColor(Color.White);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //数值显示
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(540:17)", "entry");
                        //数值显示
                        Row.justifyContent(FlexAlign.Center);
                        //数值显示
                        Row.alignItems(VerticalAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(541:19)", "entry");
                        Text.fontSize(this.button_icon_size);
                        Text.fontWeight(FontWeight.Bold);
                        Text.width(85);
                        Text.height(50);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(553:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('右');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(554:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(558:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(559:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //y控制（前后）
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(601:15)", "entry");
                        Context.animation({ duration: 250, curve: Curve.EaseInOut });
                        //y控制（前后）
                        Row.width('90%');
                        //y控制（前后）
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(602:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(603:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777257, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(604:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('前');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(627:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //数值显示
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(633:17)", "entry");
                        //数值显示
                        Row.justifyContent(FlexAlign.Center);
                        //数值显示
                        Row.alignItems(VerticalAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(634:19)", "entry");
                        Text.fontSize(this.button_icon_size);
                        Text.fontWeight(FontWeight.Bold);
                        Text.width(85);
                        Text.height(50);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(646:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('后');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(647:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(651:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777256, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(652:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //z轴控制（上下）
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(694:15)", "entry");
                        Context.animation({ duration: 250, curve: Curve.EaseInOut });
                        //z轴控制（上下）
                        Row.width('90%');
                        //z轴控制（上下）
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(695:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(696:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777257, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(697:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('上');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(720:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //数值显示
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(726:17)", "entry");
                        //数值显示
                        Row.justifyContent(FlexAlign.Center);
                        //数值显示
                        Row.alignItems(VerticalAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(727:19)", "entry");
                        Text.fontSize(this.button_icon_size);
                        Text.fontWeight(FontWeight.Bold);
                        Text.width(85);
                        Text.height(50);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(739:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('下');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(740:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(744:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777256, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(745:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(787:15)", "entry");
                        Context.animation({ duration: 250, curve: Curve.EaseInOut });
                        //控制末端的释放和抓取
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create({ space: 10 });
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(788:17)", "entry");
                        Row.justifyContent(FlexAlign.Center);
                        Row.alignItems(VerticalAlign.Center);
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(790:19)", "entry");
                        // 根据状态显示不同文本
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/device/RobotArm3.ets", line: 846, col: 11 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            // 请替换为您的图标资源
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/device/RobotArm3.ets", line: 872, col: 11 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            icon: { "id": 16777263, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" },
...
class ActionButton extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(936:5)", "entry");
            Context.animation({ duration: 150, curve: Curve.EaseOut });
            Row.width(44);
            Row.height(44);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(937:7)", "entry");
            Image.width(22);
            Image.height(22);
            Image.fillColor(Color.White);
        }, Image);
