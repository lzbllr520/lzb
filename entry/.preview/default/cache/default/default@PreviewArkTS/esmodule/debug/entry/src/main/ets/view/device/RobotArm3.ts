...
export class RobotArm3 extends ViewPU {
    ...
    private buildImagePreview(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(190:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(191:7)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(199:7)", "entry");
            Image.width('50%');
    ...
    private buildRegionA(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(214:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
            Stack.clip(true);
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(215:7)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('这里是区域A');
            Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(216:9)", "entry");
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(245:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 20 });
            Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(246:7)", "entry");
            Row.padding(20);
            Row.width('100%');
            Row.height('100%');
            ...
            if (!this.data.isInfoCardVisible) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //基础信息展示
                        Stack.create();
                        Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(249:11)", "entry");
                        //基础信息展示
                        Stack.width('30%');
                        //基础信息展示
                        Stack.height('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(250:13)", "entry");
                        Column.width('100%');
                        Column.height('100%');
                        Column.backdropBlur(12);
                        Column.backgroundColor('rgba(10, 10, 15, 0.3)');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        //模型展示
                        Column.create();
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(253:15)", "entry");
                        //... (内容与原来一致，此处省略以保持简洁)
                        //模型展示
                        Column.width('90%');
                        //... (内容与原来一致，此处省略以保持简洁)
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(254:17)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(274:15)", "entry");
                        //信息展示
                        Column.width('100%');
                        //信息展示
                        Column.height('70%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //机械臂名称
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(277:17)", "entry");
                        //机械臂名称
                        Row.width('100%');
                        //机械臂名称
                        Row.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('名称：');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(278:19)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('机械臂003');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(282:19)", "entry");
                        Text.fontColor(Color.White);
                    }, Text);
                    Text.pop();
                    //机械臂名称
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //机械臂状态
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(290:17)", "entry");
                        //机械臂状态
                        Row.width('100%');
                        //机械臂状态
                        Row.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('运作状态：');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(291:19)", "entry");
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontSize(20);
                        Text.fontColor(Color.White);
                    }, Text);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(295:19)", "entry");
                        Text.fontColor(Color.White);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Circle.create();
                        Circle.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(297:19)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //末端状态
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(308:17)", "entry");
                        //末端状态
                        Row.width('100%');
                        //末端状态
                        Row.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('末端状态：');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(309:19)", "entry");
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontSize(20);
                        Text.fontColor(Color.White);
                    }, Text);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(313:19)", "entry");
                        Text.fontColor(Color.White);
                    }, Text);
                    Text.pop();
                    //末端状态
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //负载状态
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(321:17)", "entry");
                        //负载状态
                        Row.width('100%');
                        //负载状态
                        Row.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('负载：');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(322:19)", "entry");
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontSize(20);
                        Text.fontColor(Color.White);
                    }, Text);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(326:19)", "entry");
                        Text.fontColor(Color.White);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        if (this.data.loadText === '有物品') {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(329:21)", "entry");
                                    Image.width(20);
                                    Image.height(20);
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(334:21)", "entry");
                                    Image.width(20);
                                    Image.height(20);
                                    Image.margin({ left: 10 });
                                }, Image);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //控制按钮
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(345:17)", "entry");
                        ...
                        if (this.data.statusText === '运行中' || this.data.statusText === '空闲中') {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(347:21)", "entry");
                                    Image.width(22);
                                    Image.height(22);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('停止');
                                    Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(349:21)", "entry");
                                    Text.fontSize(18);
                                    Text.fontWeight(FontWeight.Bold);
                                    Text.fontColor(Color.White);
                                    Text.margin({ left: 8 });
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(351:21)", "entry");
                                    Image.width(24);
                                    Image.height(24);
                                    Image.fillColor(Color.White);
                                }, Image);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('启动');
                                    Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(353:21)", "entry");
                                    Text.fontSize(18);
                                    Text.fontWeight(FontWeight.Bold);
                                    Text.fontColor(Color.White);
                                    Text.margin({ left: 8 });
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //地图信息卡片
                        Stack.create();
                        Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(484:11)", "entry");
                        //地图信息卡片
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(485:13)", "entry");
                        Column.width('100%');
                        Column.height('100%');
                        Column.justifyContent(FlexAlign.Center);
                        Column.alignItems(HorizontalAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(486:15)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(24);
                    }, Text);
                    Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(517:9)", "entry");
            //控制区域
            ...
            if (this.data.isRegionAVisible) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(523:13)", "entry");
                        // 原有的控制面板UI
                        Column.justifyContent(FlexAlign.Center);
                        // 原有的控制面板UI
                        Column.width('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //控制x轴（左右）
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(525:15)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(526:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(527:19)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(528:21)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('左');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(551:19)", "entry");
                        Text.fontColor(Color.White);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //数值显示
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(557:17)", "entry");
                        //数值显示
                        Row.justifyContent(FlexAlign.Center);
                        //数值显示
                        Row.alignItems(VerticalAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(558:19)", "entry");
                        Text.fontSize(this.button_icon_size);
                        Text.fontWeight(FontWeight.Bold);
                        Text.width(85);
                        Text.height(50);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(570:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('右');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(571:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(575:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(576:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //y控制（前后）
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(622:15)", "entry");
                        Context.animation({ duration: 250, curve: Curve.EaseInOut });
                        Gesture.create(GesturePriority.Low);
                        LongPressGesture.create();
                        LongPressGesture.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(623:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(624:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777257, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(625:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('前');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(648:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //数值显示
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(654:17)", "entry");
                        //数值显示
                        Row.justifyContent(FlexAlign.Center);
                        //数值显示
                        Row.alignItems(VerticalAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(655:19)", "entry");
                        Text.fontSize(this.button_icon_size);
                        Text.fontWeight(FontWeight.Bold);
                        Text.width(85);
                        Text.height(50);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(667:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('后');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(668:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(672:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777256, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(673:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //z轴控制（上下）
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(719:15)", "entry");
                        Context.animation({ duration: 250, curve: Curve.EaseInOut });
                        Gesture.create(GesturePriority.Low);
                        LongPressGesture.create();
                        LongPressGesture.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(720:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(721:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777257, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(722:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('上');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(745:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //数值显示
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(751:17)", "entry");
                        //数值显示
                        Row.justifyContent(FlexAlign.Center);
                        //数值显示
                        Row.alignItems(VerticalAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(752:19)", "entry");
                        Text.fontSize(this.button_icon_size);
                        Text.fontWeight(FontWeight.Bold);
                        Text.width(85);
                        Text.height(50);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(764:17)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('下');
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(765:19)", "entry");
                        Text.fontColor(Color.White);
                        Text.fontSize(this.button_icon_size);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(769:19)", "entry");
                        Button.width(this.button_size);
                        Button.height(this.button_size);
                        Button.backgroundColor(Color.Transparent);
                        Button.onTouch((event: TouchEvent) => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777256, "type": 20000, params: [], "bundleName": "com.my.myapplication", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(770:21)", "entry");
                        Image.width(this.button_icon_size);
                        Image.height(this.button_icon_size);
                    }, Image);
                    Button.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(817:15)", "entry");
                        Context.animation({ duration: 250, curve: Curve.EaseInOut });
                        //控制末端的释放和抓取
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create({ space: 10 });
                        Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(818:17)", "entry");
                        Row.justifyContent(FlexAlign.Center);
                        Row.alignItems(VerticalAlign.Center);
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(820:19)", "entry");
                        // 根据状态显示不同文本
...
class ActionButton extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(974:5)", "entry");
            Context.animation({ duration: 150, curve: Curve.EaseOut });
            Row.width(44);
            Row.height(44);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/device/RobotArm3.ets(975:7)", "entry");
            Image.width(22);
            Image.height(22);
            Image.fillColor(Color.White);
        }, Image);
