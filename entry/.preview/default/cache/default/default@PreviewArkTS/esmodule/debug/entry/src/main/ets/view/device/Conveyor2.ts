...
export class Conveyor2 extends ViewPU {
    ...
    private buildImagePreview(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(271:5)", "entry");
            // 使用Stack作为根布局，以实现覆盖效果
            Stack.width('100%');
            // 使用Stack作为根布局，以实现覆盖效果
            Stack.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(273:7)", "entry");
            // 半透明背景遮罩，本身就作为可点击关闭的区域
            Column.width('100%');
            // 半透明背景遮罩，本身就作为可点击关闭的区域
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(283:7)", "entry");
            // 居中显示的、放大的图片
            Image.width('50%');
            // 居中显示的、放大的图片
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(298:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 20 });
            Row.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(299:7)", "entry");
            Row.padding(20);
            Row.width('100%');
            Row.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //基础信息卡片
            Column.create();
            Column.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(301:9)", "entry");
            //基础信息卡片
            Column.width('30%');
            //基础信息卡片
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(302:11)", "entry");
            Column.width('90%');
            Column.height('30%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(303:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(322:11)", "entry");
            Column.width('100%');
            Column.height('70%');
            Column.alignItems(HorizontalAlign.Center);
            Column.justifyContent(FlexAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //传送带名称
            Row.create();
            Row.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(325:13)", "entry");
            //传送带名称
            Row.width('100%');
            //传送带名称
            Row.justifyContent(FlexAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('名称：');
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(326:15)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('传送带002');
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(330:15)", "entry");
            Text.fontColor(Color.White);
        }, Text);
        Text.pop();
        //传送带名称
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //传送带状态
            Row.create();
            Row.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(338:13)", "entry");
            //传送带状态
            Row.width('100%');
            //传送带状态
            Row.justifyContent(FlexAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('状态：');
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(339:15)", "entry");
            Text.fontWeight(FontWeight.Bold);
            Text.fontSize(20);
            Text.fontColor(Color.White);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(343:15)", "entry");
            Text.fontColor(Color.White);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create();
            Circle.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(345:15)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //传送带速度
            Row.create();
            Row.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(356:13)", "entry");
            //传送带速度
            Row.width('100%');
            //传送带速度
            Row.justifyContent(FlexAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('运行速度：');
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(357:15)", "entry");
            Text.fontWeight(FontWeight.Bold);
            Text.fontSize(20);
            Text.fontColor(Color.White);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(361:15)", "entry");
            Text.fontColor(Color.White);
        }, Text);
        Text.pop();
        //传送带速度
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //传送带负载状态
            Row.create();
            Row.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(369:13)", "entry");
            //传送带负载状态
            Row.width('100%');
            //传送带负载状态
            Row.justifyContent(FlexAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('负载：');
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(370:15)", "entry");
            Text.fontWeight(FontWeight.Bold);
            Text.fontSize(20);
            Text.fontColor(Color.White);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(374:15)", "entry");
            Text.fontColor(Color.White);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.data.loadText === '有物品') {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(377:17)", "entry");
                        Image.width(20);
                        Image.height(20);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(382:17)", "entry");
                        Image.width(20);
                        Image.height(20);
                        Image.margin({ left: 10 });
                    }, Image);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //控制按钮 (已添加点击和悬浮动画)
            Row.create();
            Row.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(393:13)", "entry");
            ...
            Row.onTouch((event: TouchEvent) => {
                ...
                if (event.type === TouchType.Up || event.type === TouchType.Cancel) {
                    ...
                    const message = isCurrentlyRunning ? '您确定要停止传送带002吗？' : '您确定要启动传送带002吗？';
                    //显示确认对话框
                    AlertDialog.show({
                        title: '操作确认',
                        message: message,
                            ...
                            },
                            {
                                ...
                                action: () => {
                                    if (isCurrentlyRunning) {
                                        ...
                                        this.addLog('warning', '关闭了传送带002，停止了对传送带002的操作。', true);
                                    }
                                    else {
                                        this.data.statusText = '运行中';
                                        this.data.speedValue = 10;
                                        this.showSystemToast('启动成功');
                                        this.addLog('info', '启动了传送带002，要对传送带002进行操作。', true);
                                    }
                                }
                            }
                        ]
            ...
            if (this.data.statusText === '运行中') {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(395:17)", "entry");
                        Image.width(22);
                        Image.height(22);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('停止');
                        Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(397:17)", "entry");
                        Text.fontSize(18);
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontColor(Color.White);
                        Text.margin({ left: 8 });
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(399:17)", "entry");
                        Image.width(24);
                        Image.height(24);
                        Image.fillColor(Color.White);
                    }, Image);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('启动');
                        Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(401:17)", "entry");
                        Text.fontSize(18);
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontColor(Color.White);
                        Text.margin({ left: 8 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //速度调节卡片
            Column.create({ space: 20 });
            Column.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(513:9)", "entry");
            //速度调节卡片
            Column.width('65%');
            //速度调节卡片
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(532:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(534:13)", "entry");
            // 减速按钮
            Button.width(50);
            // 减速按钮
            Button.height(50);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('-');
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(535:15)", "entry");
            Text.fontSize(26);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(Color.White);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 当前速度值显示
            Row.create();
            Row.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(555:13)", "entry");
            // 当前速度值显示
            Row.justifyContent(FlexAlign.Center);
            // 当前速度值显示
            Row.alignItems(VerticalAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(556:15)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('%');
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(570:15)", "entry");
            Text.fontSize(28);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(Color.White);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 加速按钮
            Button.createWithChild({ type: ButtonType.Circle, stateEffect: true });
            Button.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(580:13)", "entry");
            // 加速按钮
            Button.width(50);
            // 加速按钮
            Button.height(50);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('+');
            Text.debugLine("entry/src/main/ets/view/device/Conveyor2.ets(581:15)", "entry");
            Text.fontSize(28);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(Color.White);
        }, Text);
