...
class CameraPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/pages/Camera.ets(296:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
            ...
            if (this.isPreviewing) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        XComponent.debugLine("entry/src/main/ets/pages/Camera.ets(300:9)", "entry");
                        //相机实时预览
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/Camera.ets(314:9)", "entry");
                        Column.width('100%');
                        Column.height('100%');
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/Camera.ets(315:11)", "entry");
                        Row.width('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/Camera.ets(316:13)", "entry");
                        Button.width(40);
                        Button.height(40);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/pages/Camera.ets(317:15)", "entry");
                        Image.width(24);
                        Image.height(24);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Blank.create();
                        Blank.debugLine("entry/src/main/ets/pages/Camera.ets(322:11)", "entry");
                    }, Blank);
                    Blank.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/Camera.ets(323:11)", "entry");
                        Row.width('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/Camera.ets(324:13)", "entry");
                        Button.width(80);
                        Button.height(80);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('拍照');
                        Text.debugLine("entry/src/main/ets/pages/Camera.ets(325:15)", "entry");
                        Text.fontSize(20);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        //照片预览和保存
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/Camera.ets(334:9)", "entry");
                        //照片预览和保存
                        Column.width('100%');
                        //照片预览和保存
                        Column.height('100%');
                        ...
                        if (this.capturedPixelMap) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("entry/src/main/ets/pages/Camera.ets(336:13)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 底部操作栏
                        Row.create({ space: 30 });
                        Row.debugLine("entry/src/main/ets/pages/Camera.ets(342:11)", "entry");
                        // 底部操作栏
                        Row.width('100%');
                        // 底部操作栏
                        Row.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        SaveButton.debugLine("entry/src/main/ets/pages/Camera.ets(351:13)", "entry");
                        //安全保存按钮
