...
export type { AxisInterface, InterfaceObj, LegendInterface, TooltipInterface, SeriesInterface, DataZoomInterface, OptionInterface, RadarInterface, AnimationInterface };
